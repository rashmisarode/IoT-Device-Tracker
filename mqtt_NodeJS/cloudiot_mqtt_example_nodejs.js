...
const publishAsync = (
  ...
  setTimeout(() => {
    ...
    temp.stdout.on('data', function(data) {
        ...
        cpuTemp = data/1000;
           //const payload = `${argv.registryId}/${argv.deviceId}-payload-test-${messagesSent}`;
           console.log("CPU:",cpuTemp);
    const payload = {
      cpuTemp: cpuTemp,
      time: Date.now(),
      device: argv.deviceId  
    };
    ...
    const schedulePublishDelayMs = argv.messageType === 'events' ? 5000 : 10000;
    setTimeout(() => {
